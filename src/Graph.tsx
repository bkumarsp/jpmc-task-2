...
class Graph extends Component<IProps, {}> {
  ...
  componentDidMount() {
    // Updated code. Get element to attach the table from the DOM.
    ...
    if (this.table) {
      ...
      elem.setAttribute('row-pivots', '["timestamp"]'); //row axis datapoint
  ...
  componentDidUpdate() {
    ...
    if (this.table) {
      // Aggregate property will remove duplicate data
